...
class AuthorizerTest {
    ...
    void shouldReturnHighFrequencySmallIntervalViolation_whenFourTransactionAreMadeInLessThenTowMinutes() {
        ...
        AccountCreation account = buildAccountCreation(true, 100);
        TransactionCreation burgerKing = buildTransactionCreation("Burger King", 20, "2019-02-13T11:00:00.000");
        TransactionCreation habbibs = buildTransactionCreation("Habbib's", 20, "2019-02-13T11:00:01.000");
        TransactionCreation mcDonalds = buildTransactionCreation("McDonald's", 20, "2019-02-13T11:01:01.000");
